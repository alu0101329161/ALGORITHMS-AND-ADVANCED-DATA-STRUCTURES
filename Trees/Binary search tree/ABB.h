...
class ABB {
    ...
    void Insertar(const T& clave) { InsertarRama(raiz_, clave); }
    void Buscar(T& clave) { BuscarRama(raiz_, clave); }
    void Eliminar(T& clave) { EliminarRama(raiz_, clave); }
    ...
    void Sustituir (nodoABB<T>* &eliminar, nodoABB<T>* &sust);
    ...
    void EliminarRama (nodoABB<T>* &nodo, T clave);    
    void InsertarRama (nodoABB<T>* &nodo, T clave_dada);    
